...
class BookController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.books.index', compact('books', 'book_types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator.books.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('operator.books.show', compact('book'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.books.edit', compact('book', 'book_types'));
    }
