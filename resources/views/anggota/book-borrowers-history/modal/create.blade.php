          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <select class="form-control" name="book_id" id="book_id_create" style="width: 100%; min-height: 45px;">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="notes" id="notes_create" rows="5"></textarea>
              </div>
            </div>
          </div>
      </div>
