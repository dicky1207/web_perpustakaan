@extends('layouts.grim.index', ['title' => 'Detail Histori ' . $book_user->user->name, 'section_header' => 'Detail Histori ' . $book_user->user->name])
...
<div class="row">
  ...
  <div class="col-lg-5">
    ...
    <div class="py-4">
      <a href="{{ route('operator.book-borrowers-history.index') }}" class="btn btn-primary">Kembali</a>
