@extends('layouts.grim.index', ['title' => 'Daftar Buku', 'section_header' => 'Daftar Buku'])
      ...
      <table class="table table-hovered text-center table-bordered" id="datatable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('operator.books.show', $book->id) }}" data-id="{{ $book->id }}" class="btn btn-sm btn-info mr-2 swal-show-a">
