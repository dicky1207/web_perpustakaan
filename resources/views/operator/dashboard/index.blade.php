@extends('layouts.grim.index', ['title' => 'Dashboard Operator', 'section_header' => 'Dashboard Operator'])
...
<div class="row">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <div class="card card-statistic-2 card-modern">
        <a href="{{ route('operator.books.index') }}">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <div class="card card-statistic-2 card-modern">
        <a href="{{ route('operator.book-types.index') }}">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
    <div class="card card-statistic-2 card-modern">
        <a href="{{ route('operator.book-borrowers.index') }}">
...
@push('modal')
@include('operator.dashboard.modal.show')
@endpush
